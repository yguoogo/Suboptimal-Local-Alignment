...
# package code goes here
    ...
    function getFilteredAllSuboptimalAlignment(dataPath; indelPenalty = -3, affineStart = -12, affineExtend = -1, threshold = 30, width = 3, useAffine = true, plotAllAlignments = false, plotGroupAlignments = false)
